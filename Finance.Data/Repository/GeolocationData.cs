...
{
    public class GeolocationData : IGeolocationData
    {
        private readonly string _connectionString;

        public GeolocationData(IConfiguration configuration)
        {
        ...
        {
            string storedProcedureName = "Finance_Procedure_Geolocation_Place_Insert";
