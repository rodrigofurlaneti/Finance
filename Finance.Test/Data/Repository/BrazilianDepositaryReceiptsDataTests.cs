...
namespace Finance.Tests.Data.Repository
{
    ...
    {
        [Fact]
        public void GetAllActiveBdr_ReturnsListOfActive()
        {
            // Arrange
            ...
            var repository = new BrazilianDepositaryReceiptsData(mockConnection.Object);
        ...
        [Fact]
        public async Task GetAllActiveBdrAsync_ReturnsListOfActive()
        {
            // Arrange
            var mockConnection = new Mock<IDbConnectionWrapper>();
            var mockCommand = new Mock<IDbCommandWrapper>();
